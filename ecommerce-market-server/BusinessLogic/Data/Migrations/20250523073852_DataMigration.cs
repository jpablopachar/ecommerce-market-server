        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MailingAddress_Street = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_Department = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingTypeId = table.Column<int>(type: "int", nullable: true),
                    SubTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AttemptPaymentId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderedItem_ItemProductId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemOrders_PurchaseOrders_PurchaseOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemOrders_PurchaseOrderId",
                table: "ItemOrders",
